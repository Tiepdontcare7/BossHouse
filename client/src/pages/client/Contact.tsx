        ...
        <div className="mt-[5px]">
            ...
            <div>
                ...
                <form className="max-w-md lg:ml-[200px] lg:mt-10 md:ml-[20px] md:mt-[20px] ml-[20px] pt-[10px]">
                    ...
                    <button className="shadow-xl rounded-md  mt-[5px] group relative min-h-[50px] w-40 overflow-hidden border border-blue-500 bg-white text-blue-500  transition-all before:absolute before:left-0 before:top-0 before:h-0 before:w-1/4 before:bg-blue-500 before:duration-500 after:absolute after:bottom-0 after:right-0 after:h-0 after:w-1/4 after:bg-blue-500 after:duration-500 hover:text-white hover:before:h-full hover:after:h-full">
                        ...
                        <span className="absolute bottom-0 left-0 right-0 top-0 z-10 flex h-full w-full items-center justify-center group-hover:text-white font-medium">Submit</span>
                    </button>
                </form>

                                ...
                                <div className="add-to-cart-container">
                                    ...
                                    <form className="cart flex flex-wrap " action="https://chomeocanh.com/vay-phoi-mau-claccsic/" method="post" >
                                        ...
                                        <div className="quantity me-4 h-full items-center whitespace-nowrap">
                                            ...
                                            <input type="text" className="border-y text-center max-w-[80px] overflow-hidden p-2 text-[#666] shadow bg-white" name="quantity" value={quantity} onChange={handleChange} aria-label="Product quantity" min="1" max="" step="1" inputMode="numeric" autoComplete="on" />
                                        ...
                                        <button type="submit" name="add-to-cart" className="bg-[#2e3192] mb-4  p-2 rounded-md text-xl text-white max-[460px]:mt-4">Thêm vào giỏ hàng</button>
                                    </form>
                                </div>

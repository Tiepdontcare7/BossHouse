...
const Blog = () => {
    return (
            <div className=" h-auto   xl:px-[80px]  px-[10px] pb-[64px] ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-5 mt-[15px] ">
                    <div className="text-center mt-[35px] hover:shadow-xl border pb-3 ">
                        ...
                        <div className="px-[10px]">
                            <h3 className=" font-medium  xl:text-2xl text-[20px] mt-3 "> Chó có nên ăn chay hay không ?</h3>
                            <div className="meta-author   xl:text-[17px] xl:block lg:hidden md:hidden hidden text-base xl:mx-[110px]  lg:ml-[70px] md:ml-[280px] mx-[110px] my-[10px] ">
                                <div className="flex">
                                    ...
                                    <span className="vcard author author_name">
                                        <span className="  font-medium cursor-pointer">Theboss</span>
                                    </span>
                                </div>
                            </div>
                            ...
                            <Link to="/blogDetail"><button className="text-[rgb(167,34,35)]  text-[14px] hover:text-white hover:bg-[blue] px-6 py-2 xl:text-base  font-bold mt-4">XEM THÊM</button></Link>
                        </div>
                    </div>
                    {/* name1 */}
                    <div className="text-center mt-[35px] hover:shadow-xl border pb-3 ">
                        ...
                        <div className="px-[10px]">
                            <h3 className=" font-medium  xl:text-2xl text-[20px] mt-3 "> Có nên cho chó ăn thức ăn tự nhiên?</h3>
                            <div className="meta-author   xl:text-[17px] xl:block lg:hidden md:hidden hidden text-base xl:mx-[110px]  lg:ml-[70px] md:ml-[280px] mx-[110px] my-[10px] ">
                                <div className="flex">
                                    <span className="mr-[10px]  font-medium "> By </span>
                                    <img
                            ...
                            <Link to="/blogDetail"><button className="text-[rgb(167,34,35)]  text-[14px] xl:text-base hover:text-white hover:bg-[blue] px-6 py-2 font-bold mt-4">XEM THÊM</button></Link>
                        </div>
                    </div>
                    {/* name2 */}
                    <div className="text-center mt-[35px] hover:shadow-xl border pb-3 ">
                        ...
                        <div className="px-[10px]">
                            <h3 className=" font-medium  xl:text-2xl text-[20px] mt-3 "> Chó con nên ăn gì? Khẩu phần ăn ra sao?</h3>
                            <div className="meta-author   xl:text-[17px] xl:block lg:hidden md:hidden hidden text-base xl:mx-[110px]  lg:ml-[70px] md:ml-[280px] mx-[110px] my-[10px] ">
                                <div className="flex">
                                    <span className="mr-[10px]  font-medium "> By </span>
                                    <img
                    ...
                    <div className="text-center mt-[35px] hover:shadow-xl border pb-3 ">
                        ...
                        <div className="px-[10px]">
                            <h3 className=" font-medium  xl:text-2xl text-[20px] mt-3 ">Bộ luật chăn nuôi cấm đánh đạp, hành hạ chó mèo</h3>
                            <div className="meta-author   xl:text-[17px] xl:block lg:hidden md:hidden hidden text-base xl:mx-[110px]  lg:ml-[70px] md:ml-[280px] mx-[110px] my-[10px] ">
                                <div className="flex">
                                    <span className="mr-[10px]  font-medium "> By </span>
                                    <img
                    ...
                    <div className="text-center mt-[35px] hover:shadow-xl border pb-3 ">
                        ...
                        <div className="px-[10px]">
                            <h3 className=" font-medium  xl:text-2xl text-[20px] mt-3 ">Sau 6 năm thất lạc, chú cún trở về trước lễ giáng sinh</h3>
                            <div className="meta-author   xl:text-[17px] xl:block lg:hidden md:hidden hidden text-base xl:mx-[110px]  lg:ml-[70px] md:ml-[280px] mx-[110px] my-[10px] ">
                                <div className="flex">
                                    <span className="mr-[10px]  font-medium "> By </span>
                                    <img
                    ...
                    <div className="text-center mt-[35px] hover:shadow-xl border pb-3 ">
                        ...
                        <div className="px-[10px]">
                            <h3 className=" font-medium  xl:text-2xl text-[20px] mt-3 "> Cậu Vàng và tranh luận gay gắt chó ta hay chó Nhật?</h3>
                            <div className="meta-author   xl:text-[17px] xl:block lg:hidden md:hidden hidden text-base xl:mx-[110px]  lg:ml-[70px] md:ml-[280px] mx-[110px] my-[10px] ">
                                <div className="flex">
                                    <span className="mr-[10px]  font-medium "> By </span>
                                    <img

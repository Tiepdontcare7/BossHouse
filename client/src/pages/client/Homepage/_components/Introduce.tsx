        ...
        <section className="bg-white py-16">
            ...
            <div className="grid md:grid-cols-2  max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 gap-5 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    <h1 className="max-w-2xl mb-4 text-lg font-bold tracking-tight leading-none md:text-3xl xl:text-2xl text-[#000000bd]">
                        Câu chuyện thương hiệu BossHouse 
                    </h1>
                    <p className="max-w-2xl mb-6  lg:mb-8 md:text-lg lg:text-lg text-[#000000bd]">
